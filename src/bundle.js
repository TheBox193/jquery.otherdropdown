...
/***/ (function(module, exports, __webpack_require__) {
	...
	(0, _jquery2.default)('[name="Test-1"]').otherDropdown();
	(0, _jquery2.default)('[name="Test-2"]').otherDropdown({ value: 'Something' });
	(0, _jquery2.default)('[name="Test-3"]').otherDropdown({ placeholder: 'Type of event?' });
	(0, _jquery2.default)('[name="Test-4"]').otherDropdown({ classes: 'lightgreen-bg' });
	(0, _jquery2.default)('[name="Test-5"]').otherDropdown({ classes: 'lightgreen-bg', value: 'Something', placeholder: 'Type of event?' });
